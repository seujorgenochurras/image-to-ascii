...
public class BufferedAsciiVideoParser {
    ...
    private final AsciiParserConfig parserConfig;
    ...
    public BufferedAsciiVideoParser(AsciiParserConfig parserConfig, PixelAnalyzerBuffer pixelAnalyzerBuffer, int maxBufferedFrames) {
    ...
    public BufferedAsciiVideoParser(AsciiParserConfig parserConfig, PixelAnalyzerBuffer pixelAnalyzerBuffer) {
        this.parserConfig = parserConfig;
        this.pixelAnalyzerBuffer = pixelAnalyzerBuffer;
